...
def add_GreetServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'proto.GreetService', rpc_method_handlers)
...
class GreetService(object):
    ...
    def Hello(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/proto.GreetService/Hello',
    ...
    def Bye(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/proto.GreetService/Bye',
            greet__pb2.GreetRequest.SerializeToString,
            greet__pb2.GreetResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
